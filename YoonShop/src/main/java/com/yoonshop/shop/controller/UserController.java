...
import com.yoonshop.shop.service.EmailService;
import com.yoonshop.shop.service.UserService;
...
public class UserController {
	...
	@PostMapping("/login")
	public String userLogin(@RequestParam("password") String pw) {
		
		System.out.println("요청결과 : " +pw);

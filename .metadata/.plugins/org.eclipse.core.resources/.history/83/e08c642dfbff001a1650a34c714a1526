				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
						<img class="d-block img-fluid"
							src="http://dyjung2073.dothome.co.kr/shop/slider1.jpg"
							
							alt="First slide">
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid"
							src="http://dyjung2073.dothome.co.kr/shop/slider2.jpg"
							alt="Second slide">
					</div>
					<div class="carousel-item">
						<img class="d-block img-fluid"
							src="http://dyjung2073.dothome.co.kr/shop/slider3.jpg"
							alt="Third slide">
					</div>
					
					<div class="carousel-item">
						<img class="d-block img-fluid"
							src="http://dyjung2073.dothome.co.kr/shop/slider4.jpg"
							alt="4 slide">
					</div>
				</div>
